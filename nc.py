...
if __name__=='__main__':
    parser=argparse.ArgumentParser(description="netcat",formatter_class=argparse.RawDescriptionHelpFormatter,epilog=textwrap.dedent('''Example:netcat.py -t 192.168.1.108 -p 5555 -l -c #
command shell
